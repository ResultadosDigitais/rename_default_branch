...
Se você não está renomeando de `master` para `main`, ajuste para os valores desejados:
    ...
    FROM=branch-anterior TO=branch-nova curl -fsSL https://raw.githubusercontent.com/ResultadosDigitais/rename_default_branch/main/rename_default_branch | bash
